...
public class player_health_manager : MonoBehaviour
{
    ...
    public class player_health_bar
    {   
        //audio source
        ...
        public void OnCollisionEnter2D(Collision2D collision)
        {
            ...
            health_bar.fillAmount =  player_health / current_level;
        }   
